...
@WebFilter({"/api/company/coupons/*","/api/company/coupons",
	"/api/company/allcoupons","/api/company/getcouponbytype/*",
	"/api/company/getcouponbyprice/*","/api/company/getcouponbydate/*"})
